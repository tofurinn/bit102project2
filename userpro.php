...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user = $result->fetch_assoc()) {
        if (password_verify($password, $user['userPass'])) {
            ...
            $_SESSION['userFullName'] = $user['userFullName'] ?? $user['userName'];
            $_SESSION['userBio'] = $user['userBio'] ?? "No bio yet.";
            $_SESSION['ticketLeftColor'] = $user['ticketLeftColor'] ?? "#000000";
            $_SESSION['userPic'] = $user['userPic'] ?? "images/default-profile.png";
