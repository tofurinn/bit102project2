...
if ($password !== $password2) {
    ...
    if ($stmt->execute()) {
        ...
        $_SESSION['userPic'] = "images/default-profile.png"; // Set default profile picture
        $_SESSION['userFullName'] = $userName; // Use username as full name initially
        $_SESSION['userBio'] = "No bio yet."; // Set default bio
        $_SESSION['ticketLeftColor'] = "#000000"; // Set default color
